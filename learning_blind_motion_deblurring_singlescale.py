...
class Model(ModelDesc):
    ...
    def _build_graph(self, input_vars):
        ...
        for t in range(1, SEQ_LEN):
            ...
            logger.info("level: {} with input shape {}".format(ll, observation[l].get_shape()))
            ...
            tf.identity((estimate + 1.0) * 128., name='estimate_t%i_l%i' % (t))

            if(l == LEVELS - 1):
                estimate_viz.append(estimate[l])
